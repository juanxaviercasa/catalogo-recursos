      ...
      <main id="inicio" className="market-main">
        ...
        <section className="market-hero inventory-cover" aria-labelledby="market-title">
          ...
          <div className="market-hero-copy">
            ...
            <span className="eyebrow"><span />FUENTES ACTIVAS · DRIVE</span>
            <h1 id="market-title">Mapa de<br /><em>recursos</em><br />ubicables.</h1>
            <p>Explora recursos indexados desde tus fuentes privadas de Drive por tipo, utilidad y compatibilidad. Cada ficha conserva el nombre original y te permite volver a su origen sin mostrar jerarquías internas.</p>
